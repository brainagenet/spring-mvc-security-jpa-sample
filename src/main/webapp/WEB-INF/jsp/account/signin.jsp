...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form id="signinForm" name="signinForm" action="<c:url value="/account/signin/"/>" method="post">
        ...
        <a href="<c:url value="/account/signup/"/>" class="text-center">Register a new membership</a>
