...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<c:url value="/static/adminlte/dist/css/skins/_all-skins.min.css"/>">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- FastClick -->
    <script src="<c:url value="/static/adminlte/plugins/fastclick/fastclick.min.js"/>"></script>
    <!-- AdminLTE App -->
    <script src="<c:url value="/static/adminlte/dist/js/app.min.js"/>"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="<c:url value="/static/adminlte/dist/js/demo.js"/>"></script>
  </body>
</html>
