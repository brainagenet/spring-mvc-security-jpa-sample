/*
 * (#) net.brainage.nest.service.AclHostServiceImpl.java
...
public class AclHostServiceImpl implements AclHostService, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        Assert.notNull(aclHostRepository, "The 'aclHostRepository' property must not be null.");
    }
